...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
                <div class="nav-profile-image">
                    <img src="public/assets/images/faces/duy.jpg" alt="profile">
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="index.php?c=user" aria-expanded="false" aria-controls="general-pages">
